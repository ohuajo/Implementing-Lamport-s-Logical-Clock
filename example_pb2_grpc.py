...
class RPCStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClockUpdate = channel.unary_unary(
                '/RPC/ClockUpdate',
                request_serializer=example__pb2.ExamplePropOut.SerializeToString,
                response_deserializer=example__pb2.ExamplePropIn.FromString,
                )
...
def add_RPCServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ClockUpdate': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=example__pb2.ExamplePropOut.FromString,
                    response_serializer=example__pb2.ExamplePropIn.SerializeToString,
            ),
    }
...
class RPC(object):
    ...
    def ClockUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/RPC/ClockUpdate',
            example__pb2.ExamplePropOut.SerializeToString,
            example__pb2.ExamplePropIn.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
